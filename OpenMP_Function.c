/*this file contains functions used for the OpenMP code*/

/*prototyping functions*/

void Absorb_Boundary(long Tri, double *Vx, double *Vz, double *Txx, double *Tzz, double *Txz,
...
void LU_Velocity(long Tri, double Dt, double *Vx1, double *Vz1, double *Txx1, double *Tzz1, double *Txz1,
...
void LU_Stress_Elastic(long Tri, double Dt, double *Txx1, double *Tzz1, double *Txz1, double *Vx1, double *Vz1,
					   long *Triangle_part, long *Neighbor_Mark, long *Series, long *Series_order,
					   double *A, double *B, double *Dx, double *Dz, double *Q, double *S, long int *ibe,
					   long int *nodes_neighbor, long int *Neighbor, long int *Edge_flag);
...
void Absorb_Boundary(long Tri, double *Vx, double *Vz, double *Txx, double *Tzz, double *Txz, double *absorb_fun_d, long *Triangle_part, long *Series, long *Series_order)
{
	long m, k, i, id, num;
